  ...
  const FocusMainDivToggle = (): void => {
    if (ref1.current) {
      ref1.current.style.display =
        ref1.current.style.display === "flex" ? "none" : "flex";
    }
  };
      ...
      {images.map((image, i) => (
        ...
        >
          <div
            ...
            onMouseEnter={(e) =>
              (e.currentTarget.className += ` ${styles.LightBoxImgHover}`)
            }
            onMouseLeave={(e) =>
              (e.currentTarget.className = styles.LightBoxImg)
            }
          >
            <img
          ...
          >
            {currentImgIndex > 0 && (
              <img
                ...
                alt="left"
                className={styles.LightBoxArrowImg}
              />
            )}
          </button>
